...
def main():
    ...
    for epoch in pbar_epoch:
        ...
        # Training
        train_results = train(dataloaders['train'], model, epoch, criterion, optimizer, params["device"], pbar=pbar_inside_epoch)
        ...
        # Validation
        validation_results = validate(dataloaders['val'], model, epoch, criterion, params["device"], pbar=pbar_inside_epoch)

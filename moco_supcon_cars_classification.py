...
# from custom files
from others.dataset import CompCarsImageFolder, WrapperDataset, TwoCropTransform
from models.resnet import resnet_cfg
from models.moco_supcon import MoCo, train
from others.losses import SupLoss
...
def set_model(train_loader) -> tuple[MoCo, SupLoss]:
    ...
    for _, labels, index in tqdm(train_loader, mininterval=0.01):
        ...
        model.init_label_information(index, labels)

    model.show_label_information()
